...
| 2 | Task 2 | `.vscode-server` stale-version pruning: RED (sandboxed `bin/`+`cli/servers/` fixtures incl. `.staging` and 0/2+-entry edge cases) → GREEN (new final section) | pending |
