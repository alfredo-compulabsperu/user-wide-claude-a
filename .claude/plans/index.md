...
| [vm-cleanup-hardening.plan.md](vm-cleanup-hardening.plan.md) | vm-cleanup.sh hardening — land stranded `18ceb9d`, rename `--yes`→`--risky`, exit-code + idempotency + coverage gates | not started |
| [vm-cleanup-hardening-loop-runbook.md](vm-cleanup-hardening-loop-runbook.md) | Loop runbook (sequential, fast mode) driving the vm-cleanup-hardening plan's 7 tasks | not started |
