...
| [lazy-loading-loop-runbook.md](lazy-loading-loop-runbook.md) | Loop runbook (sequential, fast mode, hybrid human gates) driving `.claude/PRPs/plans/lazy-loading-system.plan.md` | complete |
