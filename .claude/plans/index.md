...
| [assess-plugin-packaging-issue-42.plan.md](assess-plugin-packaging-issue-42.plan.md) | Issue #42 — assess converting repo into a distributable Claude Code plugin (5 proposals, ranked) — `/ecc-plan` variant | draft |
| [assess-plugin-packaging-issue-42-native.md](assess-plugin-packaging-issue-42-native.md) | Issue #42 — same assessment, drafted via native Claude Code plan mode (comparison variant) | draft |
